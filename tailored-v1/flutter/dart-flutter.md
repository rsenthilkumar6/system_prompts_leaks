...
- Avoid performing expensive operations, like network calls or complex computations, directly within build() methods, use isolates for those operations
...
- Avoid **deeply nested widgets**; break them into smaller components with the help of `part` and `part of`.
